...
namespace StudentPortal.Spa {
    public partial class StudentPortalSpaApplication : SpaApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static StudentPortalSpaApplication()
        {
        ...
        #endregion
        public StudentPortalSpaApplication()
        {
            Tracing.Initialize();
        ...
        private void StudentPortalSpaApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {

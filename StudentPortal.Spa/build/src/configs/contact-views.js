            ...
            selectionIndependent: [
                {
                    ...
                    location: "before",
                    onExecute: {
                        $action: { actionId: actionsId.newAction, propertyName: "Tasks" } // TODO: Where is should not be propertyName declaration. Need to use propertyName from the widget config;
                    }
                }
            ]
        },
        ...
        components: [
            {
                ...
                selectionIndependent: [
                    ...
                    {
                        type: "command",
                        parameterType: "xaf-singleChoiceAction",
                        items: [
                            {
                                text: "Save",
                                onExecute: {
...
phoneContactDetailView.components[0].type = "xaf-appbar";
phoneContactDetailView.components[1].scrollable = {
    onPullDown: {
        $action: {
            actionId: actionsId.refreshAction
        }
    }
};